...
<head runat="server">
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}html,body{width:100%;height:100%;overflow:hidden}
        ...
        .btn-icon.btn-ver-flujo:hover { color: #10b981; background: #ecfdf5; border-color: #a7f3d0; }
        ...
        /* TIMELINE STYLES */
        .timeline-wrapper{position:relative;padding-left:24px;margin-top:10px;overflow-y:auto;max-height: 400px;}
        ...
        .timeline-dot{position:absolute;left:-24px;top:4px;width:10px;height:10px;border-radius:50%;background:#64748b;border:2.5px solid #ffffff;box-shadow:0 0 0 2px #e2e8f0;}
        ...
        .timeline-card{background:#f8fafc;border-radius:10px;padding:12px 16px;border:1px solid #f1f5f9;}
    ...
    <div class="modal-visor-content" style="max-width: 600px; height: auto; max-height: 85vh;">
        <div class="modal-visor-header" style="background:#1a2a4a;border-bottom:none;">
            <h3 style="color:white;display:flex;align-items:center;gap:8px;">
                <svg viewBox="0 0 24 24" style="width:18px;height:18px;fill:white;"><path d="M23 8c0 1.1-.9 2-2 2-.18 0-.35-.02-.51-.07l-3.56 3.55c.05.16.07.34.07.52 0 1.1-.9 2-2 2s-2-.9-2-2c0-.18.02-.36.07-.52l-2.55-2.55c-.16.05-.34.07-.52.07s-.36-.02-.52-.07l-4.55 4.56c.05.16.07.33.07.51 0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2c.18 0 .35.02.51.07l4.56-4.55C8.02 9.36 8 9.18 8 9c0-1.1.9-2 2-2s2 .9 2 2c0 .18-.02.36-.07.52l2.55 2.55c.16-.05.34-.07.52-.07s.36.02.52.07l3.55-3.56C19.02 8.35 19 8.18 19 8c0-1.1.9-2 2-2s2 .9 2 2z"/></svg>
                Flujo Operativo
            </h3>
            <button type="button" onclick="cerrarModalFlujo()" style="background:#e74c3c;color:white;border:none;border-radius:6px;padding:6px 14px;font-size:12px;font-weight:700;cursor:pointer;box-shadow:0 2px 6px rgba(0,0,0,0.2);transition:background 0.2s;">CERRAR</button>
        </div>
...
<script>
    ...
    function filtrarTablaDocs() {
        ...
        // Evitar tildes para búsqueda más flexible
